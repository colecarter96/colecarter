...
const Header = () => {
  ...
  const handleLinkHover = (path: string) => {
    // Preload the route when hovering
    ...
    <header className="flex flex-col w-full">
      ...
      <div className="w-full bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="flex items-center justify-between py-8">
            ...
            <Link
              href="/"
              className="text-2xl sm:text-3xl font-bold font-['Playfair_Display'] tracking-wide hover:text-yellow-950 transition-colors duration-150"
      ...
      {/* {isLoading && (
        <div className="h-1 w-full bg-gray-200">
          <div className="h-full bg-[#895129] animate-[loading_1s_ease-in-out_infinite]"></div>
        </div>
      )} */}
    </header>
  );
